...
import { Heart, Apple, BookOpen, Shirt, BedDouble, Soup, Gift, Package, TreeDeciduous, Egg } from "lucide-react";
...
const donationTypeConfig = [
  ...
  { key: "ovos_pascoa" as keyof DonationsByType, label: "Ovos de Páscoa", icon: Egg, unit: "un" },
];
